...
def snn(address1, address2, dropout_keep_prob,
    ...
    # address1 (? 20 ,38) (batch, seq_len , vocab_size)
    # address2 (? 20 ,38) (batch, seq_len , vocab_size)
    ...
    def siamese_nn(input_vector, num_hidden):
        ...
        # input_embed_split   [(batch,vocab_size)] * seq_len
        ...
        try:
            ...
            outputs = tf.contrib.rnn.static_bidirectional_rnn(lstm_forward_cell,
                                                              ...
                                                              input_embed_split,
                                                              dtype=tf.float32)
        # output [batch, rnn_hidden_size * 2] * seq_len
        # Average The output over the sequence
        temporal_mean = tf.add_n(outputs) / input_length # [batch, rnn_hidden_size * 2]
