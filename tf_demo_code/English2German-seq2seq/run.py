...
if tf.__version__[0] < '1':
    ...
    # phish can be retrieved from github: https://github.com/tensorflow/models.git
    # put the phish dir under python search lib path.

    if not os.path.exists(local_repository):
        from git import Repo

        tf_model_repository = 'https://github.com/tensorflow/phish'
